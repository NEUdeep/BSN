...
def parse_opt():
    ...
    parser.add_argument('--feature_path',
                        type=str,
                        default="/workspace/mnt/storage/kanghaidong/action_detect_data/action_temproal_datasets_feature/activitynet_feature_cuhk/")
    ...
    parser.add_argument('--tem_batch_size', type=int, default=128) # default 16
    ...
    parser.add_argument('--pem_batch_size', type=int, default=128) # default 16
